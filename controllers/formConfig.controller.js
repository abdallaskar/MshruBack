...
export const resetDefaultFormConfig = async (req, res) => {
    try {
        const defaultFields = [
            ...
            { fieldKey: "ownerName", label: "مالك المشروع ) إدارة / قسم (", placeholder: "اسم الإدارة المالكة", isRequired: true },
            ...
            // الهدف الرئيسي
            { fieldKey: "mainProjectObjective", label: "الهدف الرئيسي للمشروع / البرنامج", placeholder: "أدخل الهدف الرئيسي", isRequired: true },

            // فترة التنفيذ
            { fieldKey: "startDate", label: "فترة التنفيذ ( من - إلي )", placeholder: "mm/dd/yyyy", isRequired: true },

            // وصف المشروع
            { fieldKey: "detailedProjectDescription", label: "الوصف التفصيلي للمشروع / البرنامج", placeholder: "يتضمن الأنشطة والمراحل التنفيذية", isRequired: true },

            // الإدارة الداعمة والشركاء
            { fieldKey: "supportingManagement", label: "الإدارة المساندة", placeholder: "الإدارة المساندة", isRequired: true },
            { fieldKey: "supportingAgency", label: "الجهة الداعمة", placeholder: "الجهة الداعمة", isRequired: true },
            ...
            { fieldKey: "authorityName", label: "اسم صاحب الصلاحية", placeholder: "اسم صاحب الصلاحية", isRequired: true },
            { fieldKey: "authorityDate", label: "تاريخ الاعتماد", placeholder: "mm/dd/yyyy", isRequired: true },
